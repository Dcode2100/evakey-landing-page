    ...
    <div className="flex flex-col lg:flex-row mt-[60px] lg:mt-[90px] w-full min-h-[70vh] relative rounded-lg">
      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="relative lg:absolute lg:left-[350px] h-auto lg:h-[45vh] w-full lg:w-[38vw] mt-4 lg:m-6 pt-4 lg:pt-[3rem]">
            <div></div>
            <h1>{routeData.HeroSection.title}</h1>
            <p className="pt-4 lg:pt-6 text-xl lg:text-[25px] font-bold ">
            ...
            <div className="h-auto lg:h-[3rem] w-full lg:w-[30rem] flex flex-col sm:flex-row gap-4 items-center pt-8 lg:pt-16 lg:ml-2">
              ...
              <button className="border bg-white border-[#1B3764] text-[#1B3764] px-6 py-2 rounded-[25px] h-[7vh] w-full sm:w-auto">
                Contact Us
              </button>
            </div>
          </div>
